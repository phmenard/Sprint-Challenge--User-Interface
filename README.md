...
A. Use specific tags to describe what you are showing the user. Make it have meaning.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
A. display block with render you tags on diferent lines, display inline will render them inline one after the other on the same line.
...
A. Git give a team of people the ability to work on the same project at any given time. And maintain version control.
